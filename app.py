...
# Thông điệp chính theo yêu cầu của sinh viên
...
def process_text_with_pytorch(text: str):
    ...
    """
    # 1. Chuyển đổi chuỗi thành danh sách mã byte/unicode
    ...
    # 3. Thực hiện phép toán tensor demo (Chuẩn hóa, reshape và tính thống kê)
...
@app.route("/")
def index():
    # Xử lý thông điệp mặc định bằng PyTorch
